...
public class BoardService {
    ...
    public ApiRespDto<?> addBoard(AddBoardReqDto addBoardReqDto, PrincipalUser principalUser) {
        ...
        try {
            ...
            if (result != 1) {
                return new ApiRespDto<>("failed", "게시믈 추가에 실패했습니다. ", null);
            }

            return new ApiRespDto<>("success", "게시물이 성공적으로 추가되었습니다. ", null);
        } catch (Exception e) {
            return new ApiRespDto<>("failed", "서버 오류로 게시물 추가에 실패하였습니다. " + e.getMessage(), null);
        }
    }
    ...
    public ApiRespDto<?> getBoardByBoardId(Integer boardId) {
        ...
        if (optionalBoard.isPresent()) {
            return new ApiRespDto<>("success", "개시물 조회 성공", optionalBoard.get());
        } else {
    ...
    public ApiRespDto<?> removeBoardByBoardId(Integer boardId, PrincipalUser principalUser) {
        ...
        try {
            ...
            if (result != 1) {
                return new ApiRespDto<>("failed", "게시믈 삭제에 실패했습니다. ", null);
            }

            return new ApiRespDto<>("success", "게시물이 성공적으로 삭제되었습니다. ", null);
        } catch (Exception e) {
            return new ApiRespDto<>("failed", "서버 오류로 게시물 삭제에 실패하였습니다. " + e.getMessage(), null);
        }
    }
    ...
    public ApiRespDto<?> updateBoardByBoardId(UpdateBoardReqDto updateBoardReqDto) {
        ...
        try {
            ...
            if (result != 1) {
                return new ApiRespDto<>("failed", "게시믈 수정에 실패했습니다. ", null);
            }

            return new ApiRespDto<>("success", "게시물이 성공적으로 수정되었습니다. ", null);
        } catch (Exception e) {
            return new ApiRespDto<>("failed", "서버 오류로 게시물 수정에 실패하였습니다. " + e.getMessage(), null);
        }
    }
}
